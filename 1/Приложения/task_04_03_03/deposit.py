...
class TimeDeposit:
    ...
    def get_profit(self, initial_sum, period):
        ...
        # Выполнить расчет
        return round(initial_sum * self._interest_rate / 100 * period / 12, 2)
...
class CompoundTimeDeposit(TimeDeposit):
    ...
    def get_profit(self, initial_sum, period):
        ...
        return round(initial_sum * (1 + self._interest_rate / 100 / 12) ** period - initial_sum, 2)
